 ...
 * @return {Object}
 */
TLDEXTRACT._extract=function(tlds, netloc) {
...
TLDEXTRACT._isIP = function (netloc) {
  return (/^(?:[0-9]{1,3}\.){3}[0-9]{1,3}/.exec(netloc) != null);
}
...
TLDEXTRACT.extract = function (url) {
  ...
  return {error: '' , subdomain: subdomain, domain: domain, tld: tld};
}
